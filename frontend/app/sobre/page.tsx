    ...
    return (
        <div className="min-h-screen bg-background pt-2 pb-20 text-foreground overflow-hidden">
            ...
            <section className="relative w-full h-[70vh] flex items-center justify-center">
                ...
                {/* Background - tamanho e posição mantidos */}
                <div
            ...
            <section className="py-20 bg-[#2A2A2A] border-y border-black/5 px-4">
                <div className="container mx-auto max-w-6xl text-center">
                    ...
                    <motion.h2
                        ...
                        transition={{ duration: 0.8 }}
                        style={{ fontFamily: 'DN' }}
                        className="text-5xl mb-4 text-white flex items-center justify-center gap-0"
                    >
                        <span>O PADRÃO</span>

                        <span className="relative inline-block w-36 h-16 -ml-4">
                            <Image
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.8, delay: 0.2 }}
                            className="bg-background border border-white/5 p-8 rounded-xl hover:border-brand-secondary/50 transition-colors"
                        >
