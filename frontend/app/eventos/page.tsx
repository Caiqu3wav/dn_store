...
export default function EventosPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
<section className="relative pt-32 pb-10 lg:pt-28 lg:pb-16 overflow-hidden bg-foreground">
  ...
  <div className="absolute inset-0 bg-gradient-to-t from-foreground via-foreground/80 to-transparent" />
        ...
        <div className="container mx-auto px-4 relative z-20 text-center text-white">
          ...
          >
            Onde cada trilha se transforma em uma nova história.
          </motion.p>
              ...
              <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-100 relative overflow-hidden">
                ...
                <div className="space-y-6 mb-10">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="block text-sm text-brand-red-primary font-bold uppercase tracking-wider mb-1">
                        Data
                      </span>
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-6 flex-1">
                    ...
                    <span className={`text-xs uppercase tracking-[0.2em] font-bold block mb-2 ${
                      isNext ? 'text-brand-red-primary' : 'text-gray-400'
                    }`}>
                      {event.date}
                    </span>
                  ...
                  <div className="mt-auto pt-6 border-t border-white/10">
                    ...
                    {isNext ? (
                      ...
                      <button
                        className="w-full bg-white/10 text-white font-bold py-3 rounded-lg hover:bg-white/20 transition-colors text-sm"
                        disabled
                      >
                        Ver Cobertura
                      </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            >
              ...
              <p className="text-black">
                Desafie a si mesmo e a outros ciclistas em percursos cuidadosamente planejados para todos os níveis.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-black">
                Explore paisagens incríveis, respire ar puro e conecte-se com o meio ambiente de forma sustentável.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-black">
                Faça novas amizades, troque experiências e faça parte da família Desafio Natureza em cada etapa.
              </p>
            </motion.div>
