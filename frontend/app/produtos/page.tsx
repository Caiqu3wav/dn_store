      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="mb-8 md:mb-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <h1 className="text-4xl md:text-5xl font-black text-brand-primary tracking-tight mb-2">
                Nossos Produtos
              </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
                ...
                >
                  <div className="lg:sticky lg:top-28 space-y-8">
                    ...
                    <div className="flex items-center justify-between">
                      <h3 className="font-bold text-brand-primary uppercase text-sm tracking-wider">Filtros</h3>
                    ...
                    <div className="space-y-3">
                      <h4 className="font-semibold text-brand-primary text-xs uppercase tracking-tight opacity-60">Buscar</h4>
                      <div className="relative">
                        <input 
                          ...
                          className="w-full bg-white border border-gray-200 rounded-xl py-3 pl-10 pr-4 text-sm outline-none focus:border-brand-secondary focus:ring-1 focus:ring-brand-secondary transition-all"
                        />
                    ...
                    {/* Categories */}
                    <div className="space-y-3">
                      <h4 className="font-semibold text-brand-primary text-xs uppercase tracking-tight opacity-60">Categorias</h4>
                      <div className="space-y-2">
                        {allCategoryNames.map(category => (
                          <label key={category} className="flex items-center gap-3 cursor-pointer group">
                            ...
                            <span className={`text-sm transition-colors ${selectedCategories.includes(category) ? 'text-brand-primary font-medium' : 'text-gray-600 group-hover:text-brand-primary'}`}>
                              {category}
                            </span>
                          </label>
                        ))}
                    ...
                    {/* Price Range */}
                    <div className="space-y-3">
                      <h4 className="font-semibold text-brand-primary text-xs uppercase tracking-tight opacity-60">Preço (R$)</h4>
                      <div className="flex items-center gap-3">
                        <input 
                          ...
                          className="w-full bg-white border border-gray-200 rounded-xl py-2 px-3 text-sm outline-none focus:border-brand-secondary focus:ring-1 focus:ring-brand-secondary transition-all"
                        />
                    ...
                    <div className="pt-6 lg:hidden">
                      <button 
                        onClick={() => setIsMobileFiltersOpen(false)}
                        className="w-full bg-brand-primary text-white py-3 rounded-xl font-bold hover:bg-brand-secondary transition-colors"
                      >
          ...
          <div className="flex-1">
            ...
            {/* Top Bar Desktop */}
            <div className="hidden lg:flex items-center justify-between bg-white p-4 rounded-2xl shadow-sm border border-gray-100 mb-8">
              <p className="text-gray-500 text-sm">
                Mostrando <strong className="text-brand-primary">{filteredAndSortedProducts.length}</strong> produtos
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="appearance-none bg-gray-50 border border-gray-200 text-brand-primary text-sm font-medium rounded-xl py-2 pl-4 pr-10 outline-none focus:border-brand-secondary focus:ring-1 focus:ring-brand-secondary transition-all cursor-pointer"
                  >
            ...
            <div className="flex lg:hidden items-center justify-between mb-6">
               ...
               <div className="relative flex-1 ml-3">
                  <select 
                    value={sortBy}
                    onChange={(e) => setSortBy(e.target.value as SortOption)}
                    className="w-full appearance-none bg-white border border-gray-200 text-brand-primary text-sm font-medium rounded-xl py-2.5 pl-4 pr-10 outline-none focus:border-brand-secondary focus:ring-1 focus:ring-brand-secondary transition-all cursor-pointer shadow-sm"
                  >
                    <option value="relevance">Relevância</option>
                    <option value="price-asc">Menor Preço</option>
                    <option value="price-desc">Maior Preço</option>
            ...
            {filteredAndSortedProducts.length > 0 ? (
                ...
                <AnimatePresence>
                  {filteredAndSortedProducts.map((product) => (
                    <motion.div
                      ...
                      className="h-full"
                    >
                      {/* Notice we pass product={product} matching the ProductCard interface */}
              ...
              <div className="flex flex-col items-center justify-center py-20 px-4 text-center bg-white rounded-3xl border border-gray-100 shadow-sm">
                ...
                <h3 className="text-xl font-bold text-brand-primary mb-2">Nenhum produto encontrado</h3>
                ...
                <button 
                  ...
                  className="mt-6 font-bold text-brand-secondary hover:text-brand-primary transition-colors border-b-2 border-brand-secondary hover:border-brand-primary pb-1"
                >
