    ...
    return (
        <footer className="bg-background flex flex-col items-center text-gray-300 border-t border-gray-800">
            <div className="mx-auto">
                ...
                <div className="grid mx-auto mt-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <a
                                href="https://www.instagram.com/lojadesafionatureza/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-3 text-white"
                            >
                                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-800 transition-colors hover:bg-brand-secondary">
                                    <Instagram className="h-5 w-5" />
                                </div>

                                <span className="text-sm hover:text-brand-secondary transition-colors">
                                    @lojadesafionatureza
                                </span>
                            </a>

                            <a
                                href="https://www.instagram.com/desafionaturezamtb/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-3 text-white "
                            >
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <span>
                                    contato@desafionatureza.com.br
                                </span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="flex flex-col items-center gap-3 mb-6">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <Image
                            src="/assets/pagamentos/visa.svg"
                            alt="Visa"
                            width={70}
                            height={42}
                            className="object-contain opacity-80 hover:opacity-100 transition"
                        ...
                        <Image
                            src="/assets/pagamentos/mastercard.svg"
                            alt="Mastercard"
                            width={80}
                            height={48}
                            className="object-contain opacity-80 hover:opacity-100 transition"
                        ...
                        <Image
                            src="/assets/pagamentos/mercadopago.svg"
                            alt="Mercado Pago"
                            width={70}
                            height={42}
                            className="object-contain opacity-80 hover:opacity-100 transition"
                ...
                <div className="border-t w-full self-center border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-center gap-4 text-white text-xs text-center md:text-left bg-black py-8">
                    <p>
                        Copyright 2018 Desafio Natureza® - Todos os direitos reservados.
                    </p>
                </div>
