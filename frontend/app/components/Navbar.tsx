    ...
    return (
        <header
            className={cn(
                ...
                isScrolled
                    ? 'bg-foreground backdrop-blur-lg border-gray-200 py-3 shadow-sm'
        ...
        >
            <div className="container mx-auto px-4 lg:px-8 flex items-center justify-between gap-4">
                ...
                <div className="hidden min-[350px]:flex flex-1 max-w-md mx-4">
                ...
                <div className="flex items-center gap-6 md:gap-8">
                    ...
                    <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-white">
                        ...
                        <Link href="/produtos" className="hover:text-brand-primary transition-colors">Produtos</Link>
                        <Link href="/eventos" className="hover:text-brand-primary transition-colors">Eventos</Link>
                        <Link href="/sobre" className="hover:text-brand-primary transition-colors">Sobre</Link>
                    </nav>
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden absolute top-full left-0 right-0 bg-white border-b border-gray-200 shadow-lg py-4 px-4 flex flex-col gap-4">
                    <div className="relative w-full mb-2 min-[350px]:hidden">
                        <input
                            type="text"
                            placeholder="Buscar produtos..."
